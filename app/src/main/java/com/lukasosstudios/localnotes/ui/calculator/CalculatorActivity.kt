...
class CalculatorActivity : TranslatedActivity() {
    ...
    private fun applyTranslatedStrings() {
        binding.calculatorTitleText.text = getString(R.string.calculator_title)
        binding.expressionText.text = getString(R.string.calculator_ready)
        binding.calculatorHelperText.text = getString(R.string.calculator_helper)
    }
