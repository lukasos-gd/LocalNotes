...
class MainActivity : TranslatedActivity() {
    ...
    private fun applyTranslatedStrings() {
        binding.eyebrowText.text = getString(R.string.eyebrow_home)
        binding.summaryLabel.text = getString(R.string.summary_label)
        binding.searchInput.hint = getString(R.string.search_hint)
        binding.newNoteButton.text = getString(R.string.new_note)
    }
    ...
    private fun toggleSelection(note: Note) {
        val wasEmpty = selectedFileNames.isEmpty()
    ...
    private fun render() {
        ...
        binding.summaryTitle.text = if (liveCount == 1) {
            getString(R.string.notes_count_one, liveCount)
        } else {
            getString(R.string.notes_count_other, liveCount)
        }
