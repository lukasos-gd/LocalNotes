...
class NoteEditorActivity : TranslatedActivity() {
    ...
    private fun applyTranslatedStrings() {
        binding.saveLabel.text = getString(R.string.save)
        binding.titleInput.hint = getString(R.string.title_hint)
        binding.bodyInput.hint = getString(R.string.body_hint)
        binding.savedLocallyText.text = getString(R.string.saved_locally_hint)
        binding.noteColorLabel.text = getString(R.string.note_color_label)
        binding.privacyTipText.text = getString(R.string.privacy_tip)
    }
