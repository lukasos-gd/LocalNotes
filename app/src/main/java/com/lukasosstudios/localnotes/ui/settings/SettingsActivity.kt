...
class SettingsActivity : TranslatedActivity() {
    ...
    private fun applyTranslatedStrings() {
        ...
        binding.settingsEyebrowText.text = getString(R.string.settings_eyebrow)
        binding.settingsHeadingText.text = getString(R.string.settings_heading)
        binding.settingsSubtitleText.text = getString(R.string.settings_subtitle)
        binding.sectionAppearanceText.text = getString(R.string.section_appearance)
        binding.sectionSortText.text = getString(R.string.section_sort)
        binding.sectionLanguageText.text = getString(R.string.section_language)
        binding.exportTemplateTitleText.text = getString(R.string.export_template_title)
        binding.exportTemplateSubtitleText.text = getString(R.string.export_template_subtitle)
        binding.sectionStorageText.text = getString(R.string.section_storage)
        binding.storageTitleText.text = getString(R.string.storage_title)
        binding.storageSubtitleText.text = getString(R.string.storage_subtitle)
        binding.sectionSecurityText.text = getString(R.string.section_security)
        binding.appLockTitleText.text = getString(R.string.app_lock_title)
        binding.appLockSubtitleText.text = getString(R.string.app_lock_subtitle)
        binding.pinRowTitleText.text = getString(R.string.pin_row_title)
        binding.sectionBackupText.text = getString(R.string.section_backup)
        binding.backupExportTitleText.text = getString(R.string.backup_export_title)
        binding.backupExportSubtitleText.text = getString(R.string.backup_export_subtitle)
        binding.backupImportTitleText.text = getString(R.string.backup_import_title)
        binding.backupImportSubtitleText.text = getString(R.string.backup_import_subtitle)
        binding.aboutTitleText.text = getString(R.string.about_title)
    }
